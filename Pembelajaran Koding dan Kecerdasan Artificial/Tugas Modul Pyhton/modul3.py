...
#2.Buatlah program menggunakan variable dan menampilkan biodata anda
#biodata
...
umur = 20
hobi = "makan"
print("Nama saya adalah", nama,". Saya beralamat di", alamat,". Umur saya adalah", umur, "tahun. Hobi saya adalah", hobi,".")
...
print("Sebuah persegi panjang memiliki panjang", panjang, "dan lebar", lebar, "dan memiliki luas sebesar", keliling_persegi_panjang, "serta keliling sebesar", lebar_persegi_panjang, ".")