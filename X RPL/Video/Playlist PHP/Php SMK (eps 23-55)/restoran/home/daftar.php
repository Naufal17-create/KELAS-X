...
<div class="form-group">
    <form action="" method="post">
        ...
        <div class="form-group w-50">
            ...
            <input type="email" name="user" required placeholder="isi user" class="form-control">
        </div>
        <div class="form-group w-50">
...
<?php
    if (isset($_POST['simpan'])) {
        ...
        if ($password === $konfirmasi) {
            $sql = "INSERT INTO tblpelanggan VALUES ('','$pelanggan','$alamat','$telp','$email','$email','$password',1)";
